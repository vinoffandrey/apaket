...
const checkboxBody = document.getElementById('bottom-top-1-1');
const checkboxBody2 = document.getElementById('bottom-top-2-1');


checkboxBody.addEventListener('click', () => {
	checkboxBody2.classList.remove('active');
	checkboxBody.classList.add('active');
});
checkboxBody2.addEventListener('click', () => {
	checkboxBody.classList.remove('active');
	checkboxBody2.classList.add('active');
});

const checkboxBody1 = document.getElementById('bottom-top-1-2');
const checkboxBody22 = document.getElementById('bottom-top-2-2');


checkboxBody1.addEventListener('click', () => {
	checkboxBody22.classList.remove('active');
	checkboxBody1.classList.add('active');
});
checkboxBody22.addEventListener('click', () => {
	checkboxBody1.classList.remove('active');
	checkboxBody22.classList.add('active');
});

const checkboxBody3 = document.getElementById('bottom-top-1-3');
const checkboxBody23 = document.getElementById('bottom-top-2-3');


checkboxBody3.addEventListener('click', () => {
	checkboxBody23.classList.remove('active');
	checkboxBody3.classList.add('active');
});
checkboxBody23.addEventListener('click', () => {
	checkboxBody3.classList.remove('active');
	checkboxBody23.classList.add('active');
});