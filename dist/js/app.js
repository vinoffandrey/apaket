...
(() => {
  ...
  (() => {
    ...
    const Ht = document.getElementById("bottom-top-1-1"),
      Nt = document.getElementById("bottom-top-2-1");
    Ht.addEventListener("click", () => {
      Nt.classList.remove("active"), Ht.classList.add("active");
    }),
      Nt.addEventListener("click", () => {
        Ht.classList.remove("active"), Nt.classList.add("active");
      });
    const qt = document.getElementById("bottom-top-1-2"),
      Rt = document.getElementById("bottom-top-2-2");
    qt.addEventListener("click", () => {
      Rt.classList.remove("active"), qt.classList.add("active");
    }),
      Rt.addEventListener("click", () => {
        qt.classList.remove("active"), Rt.classList.add("active");
      });
    const Xt = document.getElementById("bottom-top-1-3"),
      Yt = document.getElementById("bottom-top-2-3");
    Xt.addEventListener("click", () => {
      Yt.classList.remove("active"), Xt.classList.add("active");
    }),
      Yt.addEventListener("click", () => {
        Xt.classList.remove("active"), Yt.classList.add("active");
      }),
      (window.FLS = !0),
      (function (e) {
        let t = new Image();
      ...
      (function () {
        ...
        if (e.length > 0) {
          ...
          const o = Array.from(e).filter(function (e, t, i) {
          ...
          o.length > 0 &&
            (function (e) {
              ...
              let s = t.map(function (e) {
                return `(max-width:${e.value}em),${e.value}`;
              });
              (s = s.filter(function (e, t, i) {
